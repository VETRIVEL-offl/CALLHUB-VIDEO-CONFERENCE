import {
  ...
  export default function Header() {
    ...
    const invertTheme = () => {
      const theme = localStorage.getItem("CALLHUB-theme");
      localStorage.setItem("CALLHUB-theme", theme === "light" ? "dark" : "light");
          ...
          <Link to="/">
            <EuiText>
              <h2 style={{ padding: "0 1vw" }}>
                <EuiTextColor color="#0b5cff">CALLHUB</EuiTextColor>
              </h2>
            </EuiText>
          </Link>,
        ],
          ...
          >
            <EuiFlexItem grow={false} style={{ flexBasis: "fit-content" }}>
              {isDarkTheme ? (
                ...
                display="fill"
                size="s"
                color="accent" // or any other valid color value
